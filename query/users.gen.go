...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Permission = field.NewField(tableName, "permission")
	_user.LeadingProjectID = field.NewString(tableName, "leading_project_id")
	_user.LeadingProject = userBelongsToLeadingProject{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("LeadingProject", "models.Project"),
	}
...
type user struct {
	...
	LeadingProjectID field.String
	LeadingProject   userBelongsToLeadingProject
...
func (u *user) updateTableName(table string) *user {
	...
	u.Permission = field.NewField(table, "permission")
	u.LeadingProjectID = field.NewString(table, "leading_project_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["leading_project_id"] = u.LeadingProjectID
...
type userBelongsToLeadingProject struct {
	db *gorm.DB

	field.RelationField
}

func (a userBelongsToLeadingProject) Where(conds ...field.Expr) *userBelongsToLeadingProject {
	if len(conds) == 0 {
		return &a
	}
...
func (a userBelongsToLeadingProject) WithContext(ctx context.Context) *userBelongsToLeadingProject {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a userBelongsToLeadingProject) Session(session *gorm.Session) *userBelongsToLeadingProject {
...
func (a userBelongsToLeadingProjectTx) Find() (result *models.Project, err error) {
	return result, a.tx.Find(&result)
}

func (a userBelongsToLeadingProjectTx) Append(values ...*models.Project) (err error) {
...
func (a userBelongsToLeadingProjectTx) Replace(values ...*models.Project) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userBelongsToLeadingProjectTx) Delete(values ...*models.Project) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userBelongsToLeadingProjectTx) Clear() error {
	return a.tx.Clear()
}
