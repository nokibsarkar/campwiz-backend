...
type ICampaignDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []models.Campaign, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (c campaignDo) FilterWithNameAndRole(name string, role string) (result []models.Campaign, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM campaigns WHERE name = ? ")
	if role != "" {
