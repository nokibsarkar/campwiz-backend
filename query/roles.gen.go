...
type IRoleDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []models.Role, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (r roleDo) FilterWithNameAndRole(name string, role string) (result []models.Role, err error) {
